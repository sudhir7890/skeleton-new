...
export class CryptoOverviewComponent implements OnInit,  OnDestroy {
...
/**
     * Constructor
     *
     * @param {CryptoService} _ecommerceOrdersService
     */
    constructor(
        private _ecommerceOrdersService: CryptoService
    )
    {
